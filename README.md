...
>
> Install ke:
> - macOS / Linux: `curl -fsSL https://github.com/Little-Z7/ke/releases/latest/download/ke-install.sh | sh`
> - Windows: `powershell -ExecutionPolicy Bypass -c "irm https://github.com/Little-Z7/ke/releases/latest/download/ke-install.ps1 | iex"`
